...
import { setPatientList,setDiagnoseList } from "./state"; //unsure why it is from .state, and not from .state/reducers
  ...
  React.useEffect(() => {
    ...
    const fetchPatientList = async () => {
      try {
        ...
        console.log('dianose list from api is: ', diagnoseListFromApi);
